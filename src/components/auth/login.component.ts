      ...
      <div class="w-full max-w-md">
        <div class="bg-white rounded-lg shadow-lg p-8">
          ...
          <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-gray-900 mb-2">Invoice Manager</h1>
          ...
          <button
            ...
            [disabled]="loading()"
            class="w-full py-3 px-4 mb-6 bg-white border-2 border-gray-300 rounded-lg text-gray-700 font-medium hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition flex items-center justify-center gap-2"
          >
          ...
          <!-- Email/Password Form -->
          <form (ngSubmit)="tab() === 'signin' ? handleSignIn() : handleSignUp()" class="space-y-4">
            ...
            <button
              type="submit"
              [disabled]="loading()"
              class="w-full py-3 px-4 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed transition"
            >
