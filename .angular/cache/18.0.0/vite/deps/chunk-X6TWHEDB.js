...
function trySerializeI18nBlock(lView, index, context2) {
  ...
  const caseQueue = [];
  tI18n.ast.forEach((node) => serializeI18nBlock(lView, caseQueue, context2, node));
  return caseQueue.length > 0 ? caseQueue : null;
}
function serializeI18nBlock(lView, caseQueue, context2, node) {
  switch (node.kind) {
    case 0:
    ...
    case 1:
    case 2:
      node.children.forEach((node2) => serializeI18nBlock(lView, caseQueue, context2, node2));
      break;
    case 3:
      ...
      if (currentCase != null) {
        ...
        node.cases[caseIdx].forEach((node2) => serializeI18nBlock(lView, caseQueue, context2, node2));
      }
      break;
  }
}
...
var ExperimentalPendingTasks = class _ExperimentalPendingTasks {
  ...
  static {
    this.ɵfac = function ExperimentalPendingTasks_Factory(t) {
      return new (t || _ExperimentalPendingTasks)();
    };
  }
  static {
    this.ɵprov = ɵɵdefineInjectable({ token: _ExperimentalPendingTasks, factory: _ExperimentalPendingTasks.ɵfac, providedIn: "root" });
  }
};
(() => {
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-X6TWHEDB.js.map
