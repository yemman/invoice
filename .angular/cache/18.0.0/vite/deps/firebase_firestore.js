...
} from "./chunk-7SJIADGD.js";
import "./chunk-TSZOSWES.js";
...
function __PRIVATE_compareByteArrays$1(e, t) {
  for (let n = 0; n < e.length && n < t.length; ++n)
    if (e[n] !== t[n])
      return __PRIVATE_primitiveComparator(e[n], t[n]);
  return __PRIVATE_primitiveComparator(e.length, t.length);
}
...
async function __PRIVATE_ignoreIfPrimaryLeaseLoss(e) {
  if (e.code !== N.FAILED_PRECONDITION || e.message !== $)
    throw e;
  ...
  async runTransaction(e, t, n, r) {
    ...
    for (; ; ) {
      ...
      try {
        ...
        if (__PRIVATE_logDebug(U, "Transaction failed with error:", t2.message, "Retrying:", n2), this.close(), !n2)
...
var __PRIVATE_IndexBackfiller = class {
  ...
  ie(e, t) {
    ...
    return PersistencePromise.doWhile(() => true === i && r > 0, () => this.localStore.indexManager.getNextCollectionGroupToUpdate(e).next((t2) => {
      if (null !== t2 && !n.has(t2))
        return __PRIVATE_logDebug(W, `Processing collection: ${t2}`), this.se(e, t2, r).next((e2) => {
          r -= e2, n.add(t2);
        });
      i = false;
    })).next(() => t - r);
...
function __PRIVATE_decodeResourcePath(e) {
  ...
  if (__PRIVATE_hardAssert(t >= 2, 64408, {
    ...
    return __PRIVATE_hardAssert(e.charAt(0) === z && "" === e.charAt(1), 56145, {
      path: e
  ...
  switch (n) {
    ...
    case 11:
      return function __PRIVATE_compareMaps(e2, t2) {
        if (e2 === ht.mapValue && t2 === ht.mapValue)
          return 0;
        if (e2 === ht.mapValue)
          return 1;
        if (t2 === ht.mapValue)
...
function __PRIVATE_queryNormalizedOrderBy(e) {
  ...
  if (null === t.Te) {
    ...
    for (const n2 of t.explicitOrderBy)
      t.Te.push(n2), e2.add(n2.field.canonicalString());
...
var __PRIVATE_WatchChangeAggregator = class {
  ...
  Ye(e) {
    for (const t of e.Se)
      e.be && e.be.isFoundDocument() ? this.Ze(t, e.be) : this.Xe(t, e.key, e.be);
...
function __PRIVATE_fromMutation(e, t) {
  const n = t.currentDocument ? function __PRIVATE_fromPrecondition(e2) {
    ...
    if ("setToServerValue" in t3)
      __PRIVATE_hardAssert("REQUEST_TIME" === t3.setToServerValue, 16630, {
        proto: t3
      ...
      "increment" in t3 ? n2 = new __PRIVATE_NumericIncrementTransformOperation(e2, t3.increment) : fail(16584, {
        proto: t3
      });
...
function __PRIVATE_fromDbRemoteDocument(e, t) {
  let n;
  if (t.document)
    n = __PRIVATE_fromDocument(e.gt, t.document, !!t.hasCommittedMutations);
...
var __PRIVATE_FirestoreIndexValueWriter = class {
  ...
  Dt(e, t) {
    if ("nullValue" in e)
      ...
      this.Ct(t, 10), t.Ft(e.booleanValue ? 1 : 0);
    else if ("integerValue" in e)
      this.Ct(t, 15), t.Ft(__PRIVATE_normalizeNumber(e.integerValue));
      ...
      this.xt(e.stringValue, t), this.Ot(t);
    else if ("bytesValue" in e)
      this.Ct(t, 30), t.Nt(__PRIVATE_normalizeByteString(e.bytesValue)), this.Ot(t);
    else if ("referenceValue" in e)
      this.Bt(e.referenceValue, t);
    else if ("geoPointValue" in e) {
      const n = e.geoPointValue;
      this.Ct(t, 45), t.Ft(n.latitude || 0), t.Ft(n.longitude || 0);
    } else
      "mapValue" in e ? __PRIVATE_isMaxValue(e) ? this.Ct(t, Number.MAX_SAFE_INTEGER) : __PRIVATE_isVectorValue(e) ? this.Lt(e.mapValue, t) : (this.kt(e.mapValue, t), this.Ot(t)) : "arrayValue" in e ? (this.qt(e.arrayValue, t), this.Ot(t)) : fail(19022, {
        Qt: e
      });
  }
  xt(e, t) {
  ...
  Ht(e) {
    for (const t of e) {
      ...
      if (e2 < 128)
        ...
        this.Wt(960 | e2 >>> 6), this.Wt(128 | 63 & e2);
      else if (t < "\uD800" || "\uDBFF" < t)
        this.Wt(480 | e2 >>> 12), this.Wt(128 | 63 & e2 >>> 6), this.Wt(128 | 63 & e2);
      else {
  ...
  Yt(e) {
    for (const t of e) {
      ...
      if (e2 < 128)
        ...
        this.jt(960 | e2 >>> 6), this.jt(128 | 63 & e2);
      else if (t < "\uD800" || "\uDBFF" < t)
        this.jt(480 | e2 >>> 12), this.jt(128 | 63 & e2 >>> 6), this.jt(128 | 63 & e2);
      else {
        const e3 = t.codePointAt(0);
  ...
  pn(e) {
    ...
    if (this.Vn.size > 0) {
      ...
      if (!r.has(e2.field.canonicalString())) {
        const t2 = n[i];
        if (!this.wn(e2, t2) || !this.Sn(this.mn[s++], t2))
          return false;
      }
      ++i;
    }
    for (; i < n.length; ++i) {
      const e2 = n[i];
      if (s >= this.mn.length || !this.Sn(this.mn[s++], e2))
        return false;
    }
    return true;
  }
...
function __PRIVATE_computeDistributedNormalForm(e) {
  if (__PRIVATE_hardAssert(e instanceof FieldFilter || e instanceof CompositeFilter, 34018), e instanceof FieldFilter)
    return e;
...
function __PRIVATE_applyDistribution(e, t) {
  ...
  n = e instanceof FieldFilter ? t instanceof FieldFilter ? function __PRIVATE_applyDistributionFieldFilters(e2, t2) {
    ...
    if (__PRIVATE_hardAssert(e2.filters.length > 0 && t2.filters.length > 0, 48005), __PRIVATE_compositeFilterIsConjunction(e2) && __PRIVATE_compositeFilterIsConjunction(t2))
...
function __PRIVATE_applyAssociation(e) {
  if (__PRIVATE_hardAssert(e instanceof FieldFilter || e instanceof CompositeFilter, 11850), e instanceof FieldFilter)
    return e;
...
var __PRIVATE_IndexedDbIndexManager = class {
  ...
  On(e, t, n) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e2 = n[i++];
      for (const n2 of r)
        if (this.$n(t, s.fieldPath) && isArray(e2))
          r = this.Un(r, s, e2);
        else {
    ...
    if (null != i) {
      ...
      if (isArray(s))
        for (const i2 of s.arrayValue.values || [])
          n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.Bn(i2), r));
    } else
      n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, Ct, r));
    return n;
  }
  /**
...
var __PRIVATE_LruGarbageCollectorImpl = class {
  ...
  nthSequenceNumber(e, t) {
    if (0 === t)
      return PersistencePromise.resolve(__PRIVATE_ListenSequence.ue);
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r, i, s, o, _, a, u, c = 18) {
    ...
    this.qi = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.C())
      throw new FirestoreError(N.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
  ...
  async ts() {
    if (this.isPrimary && !this.ns(this.ki, Bt)) {
      ...
      if (this.Ui)
        for (const t of e)
          this.Ui.removeItem(this.ss(t.clientId));
    }
  }
  /**
  ...
  Hi(e) {
    ...
    return __PRIVATE_primaryClientStore(e).get(H).next((t) => {
      if (null !== t && this.ns(t.leaseTimestampMs, Lt) && !this._s(t.ownerId)) {
        if (this.Xi(t) && this.networkEnabled)
          return true;
        if (!this.Xi(t)) {
  ...
  runTransaction(e, t, n) {
    ...
    return this.$i.runTransaction(e, r, i, (r2) => (s = new __PRIVATE_IndexedDbTransaction(r2, this.ui ? this.ui.next() : __PRIVATE_ListenSequence.ue), "readwrite-primary" === t ? this.Ji(s).next((e2) => !!e2 || this.Hi(s)).next((t2) => {
      if (!t2)
        throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = false, this.Fi.enqueueRetryable(() => this.qi(false)), new FirestoreError(N.FAILED_PRECONDITION, $);
      return n(s);
  ...
  Ts(e) {
    return __PRIVATE_primaryClientStore(e).get(H).next((e2) => {
      if (null !== e2 && this.ns(e2.leaseTimestampMs, Lt) && !this._s(e2.ownerId) && !this.Xi(e2) && !(this.xi || this.allowTabSynchronization && e2.allowTabSynchronization))
        throw new FirestoreError(N.FAILED_PRECONDITION, kt);
    });
  }
  /**
...
var __PRIVATE_QueryEngine = class {
  ...
  getDocumentsMatchingQuery(e, t, n, r) {
    ...
    return this.ps(e, t).next((e2) => {
      ...
      if (!i.result)
        return this.ys(e, t, r, n).next((e2) => {
          i.result = e2;
        });
    }).next(() => {
      if (i.result)
      ...
      return this.ws(e, t, n2).next((r2) => {
        if (i.result = r2, this.Rs)
          return this.Ss(e, t, n2, r2.size);
      });
    }).next(() => i.result);
  }
  Ss(e, t, n, r) {
...
function __PRIVATE_localStoreExecuteQuery(e, t, n) {
  ...
  return r.persistence.runTransaction(
    ...
    (e2) => function __PRIVATE_localStoreGetTargetData(e3, t2, n2) {
      ...
      if (t2)
        return i = t2.lastLimboFreeSnapshotVersion, r.hi.getMatchingKeysForTargetId(e2, t2.targetId).next((e3) => {
          s = e3;
        });
...
async function __PRIVATE_localStoreSaveNamedQuery(e, t, n = __PRIVATE_documentKeySet()) {
  ...
  return i.persistence.runTransaction("Save named query", "readwrite", (e2) => {
    ...
    if (r.snapshotVersion.compareTo(s) >= 0)
      return i.Ti.saveNamedQuery(e2, t);
...
var __PRIVATE_WebStorageSharedClientState = class {
  ...
  Hs(e) {
    ...
    if (t.storageArea === this.storage) {
      if (__PRIVATE_logDebug(Gt, "EVENT", t.key, t.newValue), t.key === this.Xs)
  ...
  async fo(e) {
    if (e.user.uid === this.currentUser.uid)
      return this.syncEngine.Do(e.batchId, e.state, e.error);
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          __PRIVATE_logDebug(Yt, `RPC '${e}' stream ${r} received:`, i2), P.a_(i2);
      }
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
  ...
  else if (t instanceof __PRIVATE_DocumentWatchChange ? e.Ra.Ye(t) : t instanceof __PRIVATE_ExistenceFilterChange ? e.Ra.it(t) : e.Ra.et(t), !n.isEqual(SnapshotVersion.min()))
    try {
...
var __PRIVATE_BundleLoader = class {
  ...
  Wa(e) {
    ...
    if (e.qa.namedQuery)
      ...
      e.qa.document && (this.Ka[this.Ka.length - 1].document = e.qa.document, ++t);
  ...
  async za(e) {
    ...
    for (const t2 of this.Ua)
      await __PRIVATE_localStoreSaveNamedQuery(e, t2, n.get(t2.name));
...
async function __PRIVATE_syncEngineUnlisten(e, t, n) {
  ...
  if (s.length > 1)
    return r.Tu.set(i.targetId, s.filter((e2) => !__PRIVATE_queryEquals(e2, t))), void r.Pu.delete(t);
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  for (const r of e.Tu.get(t))
    e.Pu.delete(r), n && e.hu.pu(r, n);
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r of n)
    if (r instanceof __PRIVATE_AddedLimboDocument)
      e.Au.addReference(r.key, t), __PRIVATE_trackLimboChange(e, r);
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  ...
  bu(e) {
    ...
    if (!__PRIVATE_WebStorageSharedClientState.C(t))
      throw new FirestoreError(N.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
...
var __PRIVATE_BundleReaderSyncImpl = class {
   ...
   */
  Qu(e) {
    if (this.cursor + e > this.bundleData.length)
      throw new FirestoreError(N.INTERNAL, "Reached the end of bundle when more is expected.");
...
var Transaction$2 = class {
  ...
  async lookup(e) {
    if (this.ensureCommitNotCalled(), this.mutations.length > 0)
      throw this.lastTransactionError = new FirestoreError(N.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes."), this.lastTransactionError;
...
async function __PRIVATE_ensureOfflineComponents(e) {
  if (!e._offlineComponents)
    if (e._uninitializedComponentsProvider) {
      ...
      __PRIVATE_logDebug(rn, "Using default OfflineComponentProvider"), await __PRIVATE_setOfflineComponentProvider(e, new __PRIVATE_LruGcMemoryOfflineComponentProvider(void 0));
...
var FirestoreSettingsImpl = class {
  constructor(e) {
    ...
    if (void 0 === e.host) {
      ...
      this.host = e.host, this.ssl = null !== (t = e.ssl) && void 0 !== t ? t : _n;
    if (this.isUsingEmulator = void 0 !== e.emulatorOptions, this.credentials = e.credentials, this.ignoreUndefinedProperties = !!e.ignoreUndefinedProperties, this.localCache = e.localCache, void 0 === e.cacheSizeBytes)
      this.cacheSizeBytes = Mt;
    else {
      if (-1 !== e.cacheSizeBytes && e.cacheSizeBytes < Ot)
...
function collectionGroup(e, t) {
  if (e = __PRIVATE_cast(e, Firestore$1), __PRIVATE_validateNonEmptyArgument("collectionGroup", "collection id", t), t.indexOf("/") >= 0)
    throw new FirestoreError(N.INVALID_ARGUMENT, `Invalid collection ID '${t}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
  return new Query(
    e,
    /* converter= */
    null,
...
function initializeFirestore(e, t, n) {
  ...
  if (void 0 !== t.cacheSizeBytes && void 0 !== t.localCache)
    throw new FirestoreError(N.INVALID_ARGUMENT, "cache and cacheSizeBytes cannot be specified at the same time as cacheSizeBytes willbe deprecated. Instead, specify the cache size in the cache object");
  if (void 0 !== t.cacheSizeBytes && -1 !== t.cacheSizeBytes && t.cacheSizeBytes < Ot)
    throw new FirestoreError(N.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
...
function __PRIVATE_setPersistenceProviders(e, t, n) {
  if ((e = __PRIVATE_cast(e, Firestore))._firestoreClient || e._terminated)
    throw new FirestoreError(N.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
  if (e._componentsProvider || e._getSettings().localCache)
    throw new FirestoreError(N.FAILED_PRECONDITION, "SDK cache is already specified.");
  e._componentsProvider = {
    _online: t,
    _offline: n
...
function clearIndexedDbPersistence(e) {
  if (e._initialized && !e._terminated)
    throw new FirestoreError(N.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
  const t = new __PRIVATE_Deferred();
  ...
  Ac() {
    if (this.path)
      for (let e = 0; e < this.path.length; e++)
        this.fc(this.path.get(e));
  }
  fc(e) {
    if (0 === e.length)
      throw this.wc("Document fields must not be empty");
    if (__PRIVATE_isWrite(this.Ec) && cn.test(e))
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
    if (2 !== e.Ec)
      throw 1 === e.Ec ? e.wc(`${this._methodName}() can only appear at the top level of your update data`) : e.wc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
function __PRIVATE_parseData(e, t) {
  ...
  if (e instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(e2, t2) {
      if (!__PRIVATE_isWrite(t2.Ec))
        throw t2.wc(`${e2._methodName}() can only be used with update() and set()`);
      if (!t2.path)
        throw t2.wc(`${e2._methodName}() is not currently supported inside arrays`);
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r.isEqual(n))
        throw t2.wc(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);
      return {
            ...
            [Tt]: {
              arrayValue: {
                values: e3.toArray().map((e4) => {
                  if ("number" != typeof e4)
                    throw t3.wc("VectorValues must only contain numeric values.");
...
function __PRIVATE_newQueryBoundFromDocOrFields(e, t, n, r) {
  if (n[0] = getModularInstance(n[0]), n[0] instanceof DocumentSnapshot$1)
    return function __PRIVATE_newQueryBoundFromDocument(e2, t2, n2, r2, i) {
      if (!r2)
        throw new FirestoreError(N.NOT_FOUND, `Can't use a DocumentSnapshot that doesn't exist for ${n2}().`);
      const s = [];
      for (const n3 of __PRIVATE_queryNormalizedOrderBy(e2))
        if (n3.field.isKeyField())
          ...
          if (__PRIVATE_isServerTimestamp(e3))
            throw new FirestoreError(N.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n3.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
          if (null === e3) {
    ...
    }(e._query, e.firestore._databaseId, t, n[0]._document, r);
  {
    ...
    return function __PRIVATE_newQueryBoundFromFields(e2, t2, n2, r2, i2, s) {
      ...
      if (i2.length > o.length)
        throw new FirestoreError(N.INVALID_ARGUMENT, `Too many arguments provided to ${r2}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
      const _ = [];
      for (let s2 = 0; s2 < i2.length; s2++) {
        const a = i2[s2];
        if (o[s2].field.isKeyField()) {
          if ("string" != typeof a)
            throw new FirestoreError(N.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${r2}(), but got a ${typeof a}`);
          if (!__PRIVATE_isCollectionGroupQuery(e2) && -1 !== a.indexOf("/"))
            throw new FirestoreError(N.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${r2}() must be a plain document ID, but '${a}' contains a slash.`);
          const n3 = e2.path.child(ResourcePath.fromString(a));
          if (!DocumentKey.isDocumentKey(n3))
            throw new FirestoreError(N.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by documentId(), the value passed to ${r2}() must result in a valid document path, but '${n3}' is not because it contains an odd number of segments.`);
...
function __PRIVATE_validateQueryFilterConstraint(e, t) {
  if (!(t instanceof QueryFieldFilterConstraint || t instanceof QueryCompositeFilterConstraint))
    throw new FirestoreError(N.INVALID_ARGUMENT, `Function ${e}() requires AppliableConstraints created with a call to 'where(...)', 'or(...)', or 'and(...)'.`);
}
...
function documentSnapshotFromJSON(e, t, n) {
  if (__PRIVATE_validateJSON(t, DocumentSnapshot._jsonSchema)) {
    if (t.bundle === hn)
      throw new FirestoreError(N.INVALID_ARGUMENT, "The provided JSON object was created in a client environment, which is not supported.");
    ...
    const _ = o.documents;
    if (1 !== _.length)
      throw new FirestoreError(N.INVALID_ARGUMENT, `Expected bundle data to contain 1 document, but it contains ${_.length} documents.`);
...
function querySnapshotFromJSON(e, t, n) {
  if (__PRIVATE_validateJSON(t, QuerySnapshot._jsonSchema)) {
    ...
    for (const e2 of s)
      o.Wa(e2);
    if (1 !== o.queries.length)
      throw new FirestoreError(N.INVALID_ARGUMENT, `Snapshot data expected 1 query but found ${o.queries.length} queries.`);
...
function onSnapshotResume(e, t, ...n) {
  ...
  if (i.error)
    throw new FirestoreError(N.INVALID_ARGUMENT, i.error);
  let s, o = 0;
...
var WriteBatch = class {
  ...
  _verifyNotCommitted() {
    if (this._committed)
      throw new FirestoreError(N.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
  }
};
function __PRIVATE_validateReference(e, t) {
  if ((e = getModularInstance(e)).firestore !== t)
    throw new FirestoreError(N.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
  return e;
}
...
function runTransaction(e, t, n) {
  ...
  !function __PRIVATE_validateTransactionOptions(e2) {
    if (e2.maxAttempts < 1)
      throw new FirestoreError(N.INVALID_ARGUMENT, "Max attempts must be at least 1");
  }(r);
...
function __PRIVATE_tryGetString(e, t) {
  if ("string" != typeof e[t])
    throw new FirestoreError(N.INVALID_ARGUMENT, "Missing string value for: " + t);
  return e[t];
}
